...
<script type="text/javascript">
	var $form = $("#adResourceModifyAppForm");
	...
	$(function() {
	    ...
	    $("#adResourceModifyAppForm").ajaxStop(function(){
	    	ajaxbg.hide();
		...
		//取消button
		$("#btnCancelAppModify").click(function(){
			$.pdialog.closeCurrent();
			//设置页面title
...
<div class="pageContent">
	<s:form id="adResourceModifyAppForm" theme="simple" method="post"
		...
		<s:hidden name="adResource.adResourceAction" id="adResourceAction"/>
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				...
				<s:else>
					<s:textfield id="adResourceTimes" name="adResource.adResourceTimes"
						cssClass="required positiveInt" onchange="fieldTrim(this)"
						maxlength="6" min="1"></s:textfield>
				</s:else>
				&nbsp;秒
			</p>
			<p style="height: 40px;">
		...
		<div class="formBar">
			<ul>
				...
				<li><a class="button" id="btnCancelAppModify" title="取消"><span>取消</span></a></li>
			</ul>
		</div>
	</s:form>
</div>
