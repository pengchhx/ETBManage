...
<div class="pageContent">
	...
	<s:form id="adModifyAppForm" theme="simple" method="post"
		...
		<s:hidden name="adPackage.adPackageStatus" id="adPackageAppStatus" />
		...
		<div class="pageFormContent" layoutH="56">
			<div class="adPackageTable" id="adPackageTableAppModify">
				<div class="titleBar">
					<div class="titleTd">
						<b>应用广告包修改</b>
					</div>
				...
				<p>
					<label>开始时间：</label>
					<s:textfield id="adPackageBegintime1"
						name="adPackage.adPackageBegintime1" class="date"
						dateFmt="yyyy-MM-dd" minDate="%y-%M-%d" cssClass="required date" />
					<a class="inputDateButton" href="javascript:;">选择</a>
				</p>
				<p>
					<label>截止时间：</label>
					<s:textfield id="adPackageEndtime1"
			...
			<div id="adResourceListApp" style="float: left; width: 98%"></div>
		</div>
		<div class="formBar">
			<ul>
				<li><div class="button">
	...
	<script type="text/javascript">
		...
		var adModifyAppForm = $("#adModifyAppForm");
		var confirmMsg = "";
		...
		$(function() {
			...
			if (!checkEditEnable($("#adPackageAppStatus").val())) {
		...
		function modifyAdPackage(saveFlag) {
			...
			if (adModifyAppForm.valid()) {
				...
				if (saveFlag == 'save') {
					confirmMsg = "确定保存吗？";
					$("#adPackageAppStatus").val("<%=Constant.AD_PACKAGE_STATUS_ADD%>");
					adModifyAppForm.action = "ad/adPackage!modifyAdPackage.do";
				} else if(saveFlag=='commit'){//提交
					confirmMsg = "确定提交吗？";
					$("#adPackageAppStatus").val("<%=Constant.AD_PACKAGE_STATUS_COMMITTED%>");
					adModifyAppForm.action = "ad/adPackage!modifyAdPackage.do";
				}
				
				adModifyAppForm.submit();
