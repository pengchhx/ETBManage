...
<div class="pageContent">
	...
	<s:form id="adViewDoubleForm" theme="simple" method="post"
				...
				<s:if
					...
					<p style="height: 70px;">
						<label>文字通知：</label> <label class="textLabel"><s:textarea
								name="adPackage.adPackageTips" style="width: 250px;"
								readonly="true"></s:textarea></label>
					</p>
					<p style="height: 70px;">
						<label>审核意见：</label>
				...
				<s:else>
					<p style="width: 760px; height: 70px;" id="wordMsg">
						<label>文字通知：</label> <label class="textLabel"><s:textarea
								...
								style="width: 630px;"></s:textarea></label>
					</p>
				</s:else>
			</div>
			<table style="width: 98%" id="adPackageTableDoubleView">
				<tr valign="top">
				...
				<tr>
					<td style="padding-top: 0px; padding-bottom: 15px;">
						<div class="navCommonDouble" id="navCommonDoubleUpperView">
							<ul>
										...
										<div class="picDiv" align="center">
											<s:if test='#adResourceUpper.adResourceTypes=="1"'>
												...
												<div class="opreaDivDoubleUpdSetting"
													id="operaParamViewUpper<s:property value="#st.index+1" />">
											...
											<s:elseif test='#adResourceUpper.adResourceTypes=="2"'>
												...
												<div class="playButtonDivSingleUpdSetting"
													id="playButtonParamUpperView<s:property value="#st.index+1" />">
				...
				<tr>
					<td style="padding-top: 0px;">
						<div class="navCommonDouble" id="navCommonDoubleLowerView">
							<ul>
									...
									<li>
										<div class="picDiv" align="center">
											<s:if test='#adResourceLower.adResourceTypes=="1"'>
												...
												<div class="opreaDivDoubleUpdSetting"
													id="operaParamViewLower<s:property value="#st.index+1" />">
													<font>播放时长： <s:property value="adResourceTimes" />
														秒
													</font>
												</div>
											...
											<s:elseif test='#adResourceLower.adResourceTypes=="2"'>
												...
												<div class="playButtonDivSingleUpdSetting"
													id="playButtonParamLowerView<s:property value="#st.index+1" />">
													<img src="images/images_Pause_Scgedyke.png"
														style="cursor: pointer" onmouseover="playButtonOn(this)"
														onmouseout="playButtonOff(this)">
												</div>
...
<!--
	$(document).ready(
			function() {
				$("#navCommonDoubleUpperView .updPicUpper img").each(
						function(i) {
							//设置播放时长和播放次数显示：上屏
							var divPamObjUpper = $('#operaParamViewUpper'
									+ $(this).attr("idNo"));
							divPamObjUpper.css({
								position : "absolute",
							...
							//播放button显示
							var divPlayButtonObj = $('#playButtonParamUpperView'
									+ $(this).attr("idNo"));
				...
				$("#navCommonDoubleLowerView .updPicLower img").each(
						function(i) {

							//设置播放时长和播放次数显示：下屏
							var divPamObjLower = $('#operaParamViewLower'
									+ $(this).attr("idNo"));
							divPamObjLower.css({
								position : "absolute",
								left : $(this).position().left,
							...
							//播放button显示
							var divPlayButtonObj = $('#playButtonParamLowerView'
									+ $(this).attr("idNo"));
							if (divPlayButtonObj != null
									&& divPlayButtonObj != undefined) {
								divPlayButtonObj
				...
				//选中的资源图片高亮显示
				$("#adPackageTableDoubleView .updPicUpper,.updPicLower").click(function(){
					$("#adPackageTableDoubleView .updPicUpper").each(
							function(i) {
								$(this).find(".resourceImgDouble").removeClass(
										"resourceImgSelected");
							});
					
					$("#adPackageTableDoubleView .updPicLower").each(
							function(i) {
								$(this).find(".resourceImgDouble").removeClass(
										"resourceImgSelected");
							});
