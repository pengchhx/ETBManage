				...
				<div class="tabs_wrap making_wrap release_wrap no_border clearfix">
					...
					<div class="edit_wrap sc_wrap zzbj_right">
						...
						<div class="edit_content">
							...
							<div class="sc_content tabs_lis hori_li vert_li">
								<ul class="clearfix">
									<!--<li>
		...
		$(document).ready(function(){
			...
			for(var i = 0; i < vertLi.length; i ++){
				vert_li_html += "<li>" +
								 ...
								 "<div class='time_wrap'>" +
								 "<div class='time_wrap1 clearfix'><span>开始:</span><strong class='clearfix'><b>" + vertLi[i].startTime + "</b><em class='time_h'></em><em class='time_m'></em><em class='time_s'></em></strong></div>" +
								 "<div class='time_wrap1 time_wrap2 clearfix'><span>结束:</span><strong class='clearfix'><b>" + vertLi[i].endTime + "</b><em class='time_h'></em><em class='time_m'></em><em class='time_s'></em></strong></div></div>" +
