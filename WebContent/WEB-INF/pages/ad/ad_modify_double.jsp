...
<div class="pageContent">
	...
	<s:form id="adModifyDoubleForm" theme="simple" method="post"
		...
		<s:hidden name="adPackage.adPackageStatus"
			id="adPackageStatusDoubleModify" />
		...
		<div class="pageFormContent" layoutH="56">
			<div class="adPackageTable" id="adPackageTableDoubleModify">
				<div class="titleBar">
					<div class="titleTd">
						<b>分屏广告包修改</b>
					</div>
			...
			<div id="adResourceListDouble" style="float: left; width: 98%"></div>
		</div>
		<div class="formBar">
			<ul>
				<li><div class="button">
	...
	<script type="text/javascript">
		var $adModifyDoubleForm = $("#adModifyDoubleForm");
		var confirmMsg = "";
		...
		$(function() {
			...
			if(!checkEditEnable($("#adPackageStatusDoubleModify").val())){
		...
		function modifyAdPackage(saveFlag) {
			...
			if ($adModifyDoubleForm.valid()) {
				...
				if(saveFlag=='save'){
					confirmMsg = "确定保存吗？";
					$("#adPackageStatusDoubleModify").val("<%=Constant.AD_PACKAGE_STATUS_ADD%>");
					$adModifyDoubleForm.action = "ad/adPackage!modifyAdPackage.do";
				} else if(saveFlag=='commit'){//提交
					confirmMsg = "确定提交吗？";
					$("#adPackageStatusDoubleModify").val("<%=Constant.AD_PACKAGE_STATUS_COMMITTED%>");
					$adModifyDoubleForm.action = "ad/adPackage!modifyAdPackage.do";
				}
				$adModifyDoubleForm.submit();
