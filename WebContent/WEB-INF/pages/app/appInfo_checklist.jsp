...
<s:form id="pagerForm" action="app/appAction!checkAppInfoList.do" method="post" theme="simple">
...
<div class="pageHeader">
	<s:form id="appInfoCheckListForm" name="appInfoCheckListForm" action="app/appAction!checkAppInfoList.do" method="post" theme="simple" onsubmit="return navTabSearch(this);">
		<s:hidden name="pageNum"></s:hidden>
		<div class="searchBar">
		...
		<tbody>
			<s:iterator value="list" id="appInfo">
				<tr target="appInfoId" rel="<s:property value='#appInfo.appInfoId'/>">
					...
					<td><a class="inLine"
									href="app/appAction!toRead.do?vo.appInfoId=<s:property value='#appInfo.appInfoId'/>"
									target="navTab" fresh="false" resizable="false" mixable=true
									rel="toCheck" title="应用审核"><span class="btnCheck"></span><span>&nbsp;审核&nbsp;</span></a>
								</td>
				</tr>
			</s:iterator>
		</tbody>
