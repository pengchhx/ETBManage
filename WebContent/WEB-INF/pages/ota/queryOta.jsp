...
<div class="pageContent">
	...
	<s:form id="otaCheckForm" theme="simple" method="post"
		action="ota/versioninfo!releaseOta.do"
		...
		<div class="pageFormContent" layoutH="56">
			<div class="adPackageTable" style="width: 98%;">
				...
				<p>
					<label>版本名称：</label>
					<s:textfield name="otaInfo.name" width="180px" readonly="true"></s:textfield>
				</p>
				<p>
					<label>版本状态：</label>
					<s:if test="otaInfo.infostat==0">
						<input type="text" readonly="true" value="未提交">
					</s:if>
					<s:if test="otaInfo.infostat==1">
						<input type="text" readonly="true" value="待审核">
					</s:if>
					<s:if test="otaInfo.infostat==2">
						<input type="text" readonly="true" value="未发布">
					</s:if>
					<s:if test="otaInfo.infostat==3">
						<input type="text" readonly="true" value="审核驳回">
					</s:if>
					<s:if test="otaInfo.infostat==4">
						<input type="text" readonly="true" value="已发布">
					</s:if>
				</p>
				<p>
					<label>创建人：</label>
				...
				<s:if test="otaInfo.infostat==3">
					...
					<p style="width: 100%;height:90px;">
						<label>驳回意见：</label>
						<s:textfield name="otaInfo.checksuggest" readonly="true"
							style="width: 630px;" />
					</p>
				</s:if>
				<s:if test="otaInfo.infostat==4">
					...
					<p>
						<label>发布人：</label>
						<s:textfield name="otaInfo.publisher" readonly="true" />
					</p>
					<p>
						<label>发布时间：</label>
						<s:textfield name="otaInfo.publishtimedsp" readonly="true" />
					</p>
				</s:if>

				<p style="width: 760px;height:60px;">
					<label>备注：</label>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button type="button" class="close" style="width: 60px">&nbsp;返回&nbsp;</button>
						</div>
					</div></li>
			</ul>
		</div>
