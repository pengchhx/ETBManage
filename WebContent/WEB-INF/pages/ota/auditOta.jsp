...
<div class="pageContent">
	...
	<s:form id="otaCheckForm" theme="simple" method="post"
		action="ota/versioninfo!auditPassOta.do" cssClass="pageForm required-validate"
				...
				<li>
					<div class="button">
						<div class="buttonContent">
							<button type="submit"  style="width: 60px">&nbsp;通过&nbsp;</button>
						</div>
					</div>
				</li>
				<li>
					...
					href="ota/versioninfo!preUnpassOta.do?otaId=<s:property value="otaInfo.id"/>"
					width="600" height="230" rel="unpass_ota_info" title="审核意见"
